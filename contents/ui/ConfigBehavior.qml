...
KCMUtils.SimpleKCM {
    ...
    property alias cfg_scrollUpCommand: scrollUpCommand.text
    property alias cfg_scrollDownCommand: scrollDownCommand.text
    ...
    Kirigami.FormLayout {
        ...
        QQC2.ComboBox {
            ...
            model: [
                ...
                i18nc("@item:inlistbox Part of a sentence: 'Scrolling on any task executes a command'", "Executes a command")
            ]
        }
        ...
        Kirigami.FormLayout {
            visible: wheelEnabled.currentIndex === 3

            QQC2.TextField {
                id: scrollUpCommand
                Kirigami.FormData.label: i18nc("@label:textbox for scroll up command", "Scroll up command:")
                Layout.fillWidth: true
            }

            QQC2.TextField {
                id: scrollDownCommand
                Kirigami.FormData.label: i18nc("@label:textbox for scroll down command", "Scroll down command:")
                Layout.fillWidth: true
            }
        }
